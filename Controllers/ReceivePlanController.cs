...
{
    [SessionExpire]
    public class ReceivePlanController : BaseController
    {
            ...
            try
            {
                ...
                switch (submitButton)
                {
                    ...
                    case "ClearFilter":
                        ...
                        break;
                    case "Edit":
                        return RedirectToAction("PSC2110", "ReceivePlanAdjust");
                }
        ...
        [HttpPost]
        public ActionResult PSC2111(string submitButton, ReceivePlanDetailScreen modelEdit)
        {
            HHTReceiveService objHHTReceiveService = null;
            ReceivingInstruction objReceivingInstruction = null;
                        ...
                        if (ModelState.IsValid)
                        {
                            if (modelEdit != null)
                            {
                                ...
                                if (objReceivingInstructionDetailList != null)
                                {
                                    ...
                                    objReceivingInstruction.Status = IsAllReceived ? Convert.ToByte(Constants.ReceiveStatus.Receive) : Convert.ToByte(Constants.ReceiveStatus.New);
