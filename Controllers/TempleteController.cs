...
{
    public class TempleteController : BaseController
    {
        public TempleteScreen myModel
        {
            get
            {
                if (Session["TempleteScreen"] == null)
                {
                    Session["TempleteScreen"] = new TempleteScreen();
                    return (TempleteScreen)Session["TempleteScreen"];
                }
                else
                {
                    return (TempleteScreen)Session["TempleteScreen"];
            ...
            set { Session["TempleteScreen"] = value; }
        }
