...
{
    public class ReceivedPlanScreen : BaseScreen
    {
        public ReceivedPlanScreen()
        {
    ...
    public class ReceivedPlanDetailScreen : BaseScreen
    {
        public ReceivedPlanDetailScreen()
        {
    ...
    public class ReceivedPlanPatial
    {
    ...
    public class ReceivedPlanPatialScreen : BaseScreen
    {
        public ReceivedPlanPatialScreen()
        {
